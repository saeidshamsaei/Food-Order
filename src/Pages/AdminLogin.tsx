    ...
    try {
      if (isSignUp) {
        ...
        const endpoint = isAdmin
          ? "http://localhost:5000/api/admin-register" // Example admin register endpoint
          : "http://localhost:5000/api/register"; // Default register endpoint
        ...
        // Handle login logic
        const endpoint = isAdmin
          ? "http://localhost:5000/api/admin-login" // Example admin login endpoint
          : "http://localhost:5000/api/login"; // Default login endpoint

...
const Cart = ({ cart, setCart, handleChange }: CartProps) => {
  ...
  try {
    ...
    const occupiedOrdersResponse = await fetch(
      `https://food-order-ochre.vercel.app/api/orders/table/${tableNumber}/occupied`,
      {
        method: "GET",
        headers: {
    ...
    if (occupiedOrdersResponse.ok) {
      ...
      const userResponse = await fetch("https://food-order-ochre.vercel.app/api/profile", {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${token}`,
    ...
    const orderResponse = await fetch("https://food-order-ochre.vercel.app/api/orders", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        authorization: `Bearer ${token}`,
